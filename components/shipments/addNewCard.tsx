import { View, TouchableOpacity, Text, Image, TextInput, TouchableWithoutFeedback, Keyboard } from 'react-native';
      ...
      <View className="flex-1 pt-[44px] px-[15px]">
        ...
        <View className="mt-5">
          <View className="border border-[#E8E6EA] rounded-[12px] h-[67px] mt-[15px] relative mb-[10px]">
            ...
            <TextInput className="px-[15px] w-full h-full" keyboardType="numeric" />
          </View>
