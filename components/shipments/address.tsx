...
export default function ShipmentAddress({ navigation }: any) {
  ...
  const handleSenderDetails =
    (key: keyof typeof senderDetails) => (value: string) => {
    ...
    <View className="flex-1 pt-[44px] ">
      ...
      <ScrollView className="flex-1 mb-[30px] px-[15px]">
        <View className="mt-5 flex-row justify-around items-center">
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate("ShipmentAddress")}
            className="items-center"
          >
            <Image
              source={require("../../assets/app/packageProgressGreen.png")}
          ...
          >
            <Image
              source={require("../../assets/app/packageProgressGray.png")}
            />
            <Text>Payment</Text>
          </TouchableOpacity>
        </View>
        ...
        <View className="mt-[41.5px]">
          <TouchableOpacity
            onPress={() => setIsSenderOpen(!isSenderOpen)}
            className="bg-[#00997D] flex-row justify-between rounded-[12px] h-[55px] px-[22.5px] items-center"
          >
            <Text className="text-white leading-[21.78px] text-lg">
              Sender Details
            </Text>
            <Image
              source={require("../../assets/app/whiteCaretDown.png")}
              className={`${isSenderOpen ? "rotate-180" : "rotate-360"}`}
            />
          </TouchableOpacity>

          <View className={`${isSenderOpen ? "block" : "hidden"}`}>
            <View className="border border-[#E8E6EA] rounded-[12px] h-[67px] mt-[15px] relative">
              <Text className="text-xs leading-[18px] absolute -top-2 left-5 bg-gray-100 px-2 text-gray-400">
                Full Name*
              </Text>
              <TextInput
                className="px-[15px] w-full h-full"
                value={senderDetails.fullName}
                onChangeText={handleSenderDetails("fullName")}
              />
            </View>
            ...
            <View className="border border-[#E8E6EA] rounded-[12px] h-[67px] mt-[15px] relative">
              ...
              <TextInput
                ...
                onChangeText={handleSenderDetails("phoneNumber")}
              />
            </View>
            ...
            <View className="border border-[#E8E6EA] rounded-[12px] h-[67px] mt-[15px] relative">
              ...
              <TextInput
                ...
                onChangeText={handleSenderDetails("address")}
              />
            </View>
          </View>
        </View>
        ...
        <View className="mt-[41.5px]">
          <TouchableOpacity
            onPress={() => setIsReceiverOpen(!isReceiverOpen)}
            className="bg-[#00997D] flex-row justify-between rounded-[12px] h-[55px] px-[22.5px] items-center"
          >
            <Text className="text-white leading-[21.78px] text-lg">
              Receiver Details
            ...
            <Image
              source={require("../../assets/app/whiteCaretDown.png")}
              className={`${isReceiverOpen ? "rotate-180" : "rotate-360"}`}
            />
          </TouchableOpacity>
          ...
          <View className={`${isReceiverOpen ? "block" : "hidden"}`}>
            <View className="border border-[#E8E6EA] rounded-[12px] h-[67px] mt-[15px] relative">
              ...
              <TextInput
                ...
                onChangeText={handleReceiverDetails("fullName")}
              />
            </View>
            ...
            <View className="border border-[#E8E6EA] rounded-[12px] h-[67px] mt-[15px] relative">
              ...
              <TextInput
                ...
                onChangeText={handleReceiverDetails("phoneNumber")}
              />
            </View>
            ...
            <View className="border border-[#E8E6EA] rounded-[12px] h-[67px] mt-[15px] relative">
              ...
              <TextInput
                ...
                onChangeText={handleReceiverDetails("address")}
              />
            </View>
          </View>
        </View>
