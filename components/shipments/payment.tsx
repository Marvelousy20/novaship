      ...
      <ScrollView className="flex-1 mb-[30px] px-[15px]">
        ...
        <View className="mt-[30px]">
          ...
          <View className="bg-[#4E5156] px-[15px] py-4 rounded-[12px] mt-5 mb-[30px]">
            <View className="items-start flex-row gap-[9px] mb-[30px]">
              ...
              <View>
                ...
                <Text className="text-white my-2 font-semibold pr-4">
          ...
          <View className="mb-[30px]">
            <Text className="leading-[27px] text-lg font-medium">
            ...
            <View>
              <View className="flex-row items-center justify-between mt-5">
                <View className="flex-row gap-5">
                  ...
                  <View>
                    <Text className="text-sm leading-[16.94px]">
                      Debit/Credit Card
                    </Text>
                    <Text>**** **** **** 2022</Text>
                  </View>
              ...
              <TouchableOpacity
                ...
                className="border border-[#00997D] rounded-[24px] py-[16.5px] w-full mt-[15px]"
              >
                <Text className="font-[500] text-lg leading-[21.78px] text-center text-[#00997D]">
                  + Add Card
                </Text>
              </TouchableOpacity>
            </View>
            ...
            <View className="my-[30px] flex-row justify-between items-center">
              <View className="flex-row gap-5 items-center">
                <Image
                  source={require("../../assets/app/apple_pay_icon.png")}
                />
          ...
          <View className="mt-[30px] mb-[15px]">
            ...
            <View className="flex-row justify-between items-center mt-[15px] mb-[10px]">
              <Text className="font-medium leading-[21px] text-sm">
                Shipping Fee
              </Text>
          ...
          <TouchableOpacity
            ...
            className="bg-[#00997D] rounded-[24px] py-[16.5px] w-full mt-[15px]"
          >
            <Text className="font-[500] text-lg leading-[21.78px] text-center text-white">
              Pay Now
            </Text>
          </TouchableOpacity>
        </View>
